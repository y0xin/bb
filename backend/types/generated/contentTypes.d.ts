...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    position: Schema.Attribute.Enumeration<
      ['hero', 'catalog_top', 'catalog_bottom', 'sidebar']
    > &
...
export interface ApiChatMessageChatMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    messageType: Schema.Attribute.Enumeration<['text', 'image', 'product']> &
      Schema.Attribute.DefaultTo<'text'>;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    sender: Schema.Attribute.Enumeration<['user', 'admin']> &
      Schema.Attribute.Required;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.DefaultTo<'\u041E\u0431\u0449\u0435\u0435'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    paymentMethod: Schema.Attribute.Enumeration<['payme', 'click', 'naqd']> &
      Schema.Attribute.DefaultTo<'naqd'>;
    promoCode: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<
      ['yangi', 'tasdiqlangan', 'yetkazilmoqda', 'yetkazildi', 'bekor_qilindi']
    > &
      Schema.Attribute.DefaultTo<'yangi'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attributes: Schema.Attribute.DynamicZone<['product.attribute']>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    rating: Schema.Attribute.Float & Schema.Attribute.DefaultTo<5>;
    slug: Schema.Attribute.UID<'name'>;
...
export interface ApiPromoCodePromoCode extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Store discount promo codes';
...
export interface ApiQuizQuestionQuizQuestion
  ...
  info: {
    description: 'Store quiz questions for the frontend';
...
export interface ApiQuizSubmissionQuizSubmission
  ...
  info: {
    description: 'Store quiz submissions from visitors';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['new', 'processed']> &
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactEmail: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'info@promarket.ru'>;
    contactPhone: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'+7 (900) 123-45-67'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'PRO MARKET'>;
